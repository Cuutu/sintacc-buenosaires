        ...
        <div className="container mx-auto max-w-5xl px-4 pb-8 pt-[max(1.25rem,calc(var(--safe-area-top)+0.75rem))] md:pb-20 md:pt-12">
          <div className="mx-auto flex w-full max-w-[760px] flex-col items-center">
            ...
            <div className="order-4 mb-4 grid w-full grid-cols-1 gap-2 md:order-6 md:mb-0 md:grid-cols-[65fr_35fr] md:gap-3">
              ...
              <Link
                href="/sugerir"
                className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-[16px] border border-[#4E735B]/50 bg-[#F8F5EF] text-sm font-medium text-[#2D4A34] transition-colors hover:bg-[#F3EEE5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2D4A34]/30 md:h-[52px] md:border-[#4E735B]/40 md:text-base"
              >
