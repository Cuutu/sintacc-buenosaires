...
const optionalEnvVars = [
  ...
  "NEXT_PUBLIC_GOOGLE_PLACE_PHOTOS_ENABLED",
  "GOOGLE_IOS_CLIENT_ID",
  "NEXT_PUBLIC_GOOGLE_WEB_CLIENT_ID",
  "NEXT_PUBLIC_GOOGLE_IOS_CLIENT_ID",
  "NATIVE_GOOGLE_AUTH_ENABLED",
  "NATIVE_APPLE_AUTH_ENABLED",
  "PUBLIC_READ_RATE_LIMIT_LIST",
  "PUBLIC_READ_RATE_LIMIT_DETAIL",
  "PUBLIC_READ_RATE_WINDOW_MINUTES",
  "APPLE_CLIENT_ID",
  "APPLE_BUNDLE_ID",
  "APPLE_TEAM_ID",
  "APPLE_KEY_ID",
