    ...
    <>
      {!open && (
        <div className="fixed inset-x-3 bottom-[calc(var(--bottom-nav-clearance)+0.25rem)] z-[70] mx-auto max-w-[440px] md:bottom-5 md:right-5 md:left-auto">
          <button
            ...
            className="flex w-full items-center justify-between gap-3 rounded-2xl border border-olive/15 bg-cream/95 px-4 py-3 text-left text-olive shadow-[0_18px_60px_rgba(0,0,0,0.42)] backdrop-blur-2xl transition active:scale-[0.99] md:w-[360px]"
          >
      ...
      {open && (
        <div className="fixed inset-0 z-[80] flex items-end justify-center p-3 md:items-center">
          ...
          <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-olive/15 bg-cream text-olive shadow-2xl">
            <div className="flex items-start justify-between gap-3 border-b border-olive/10 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Abrila como app, sin buscarla en el navegador.</div>
                </div>
              </div>
              <button
                type="button"
                className="rounded-full p-2 text-muted-foreground transition hover:bg-olive/10 hover:text-olive"
                onClick={dismiss}
                aria-label="Cerrar"
              >
            ...
            <div className="space-y-4 px-5 py-5">
              {deferred ? (
                ...
                <div className="space-y-4">
                  {!safari && (
                    <div className="rounded-2xl border border-amber-400/25 bg-amber-400/10 px-4 py-3 text-sm text-amber-900">
                  ...
                  <ol className="space-y-3 text-sm text-muted-foreground">
                    <li className="flex gap-3">
                      <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-olive/10 font-semibold">1</span>
                      <span className="pt-1">Tocá el botón de compartir de Safari.</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-olive/10 font-semibold">2</span>
                      <span className="flex items-center gap-2 pt-1">
                        Elegí <Share2 className="h-4 w-4 text-primary" aria-hidden /> Agregar a pantalla de inicio.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-olive/10 font-semibold">3</span>
                      <span className="flex items-center gap-2 pt-1">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 rounded-2xl bg-olive/8 px-4 py-3 text-sm text-muted-foreground">
            ...
            <div className="flex gap-2 border-t border-olive/10 px-5 py-4">
              <button
                type="button"
                className="flex-1 rounded-2xl bg-olive/8 px-4 py-3 text-sm font-semibold text-muted-foreground transition hover:bg-olive/10"
                onClick={dismiss}
              >
                Después
              </button>
